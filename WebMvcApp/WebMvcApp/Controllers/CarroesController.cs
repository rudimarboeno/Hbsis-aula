...
namespace WebMvcApp.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Placa,Ativo,UsuarioCriacao,UsuarioEdicap,DataCriacao,DataAlteracao")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Placa,Ativo,UsuarioCriacao,UsuarioEdicap,DataCriacao,DataAlteracao")] Carro carro)
        {
            if (ModelState.IsValid)
            {
