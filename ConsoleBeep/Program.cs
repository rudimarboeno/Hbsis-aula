...
namespace ConsoleBeep
{
    static class Tetris
    {
        ...
        static void Main()
        {
            ...
            {
                //Atualiza o vlaor da variavel "dateVerify" com a hora e minutos atuais
            ...
            //Pega um valor de um objeto qual quer e cria uma lista para o mesmo e executa de acordo com a chamada
            switch (fileira)
            {
                //case indentifica que ele precisa fazer uma escolha
                ...
                case "10": { Fileira10(startTimerIcrement); } break;
                    //Em caso de não ser informado uma string valida para nosso menu de opções, ele executa esse cata
                default: { Console.WriteLine("Não foi uma escolha valida dentro do menu"); } break;
            }
